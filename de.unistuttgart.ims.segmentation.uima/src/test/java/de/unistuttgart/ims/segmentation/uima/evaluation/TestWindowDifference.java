...
public class TestWindowDifference {
	...
	public void setUp() throws Exception {
		...
		bd = MetricFactory.getMetric(WindowDifference.class, SegmentBoundary.class);
	}

	@Test
	public void testNoSilverBreak() {
		assertEquals(0.111111, bd.scores(gold, silv).get(bd.getClass().getSimpleName()), 1e-5);
	}
	...
	public void testBeginAndEnd() {
		...
		assertEquals(0.055555, bd.scores(gold, silv).get(bd.getClass().getSimpleName()), 1e-5);
	}
